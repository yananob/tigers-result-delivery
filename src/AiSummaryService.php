...
作成のポイント：
- **文体は「です・ます」調（敬体）ではなく、必ず「〜あった」「〜だった」「〜した」「〜である」などの常体（である調・だ調）で記述してください。**
- 勝投手など、提供された情報に存在しない項目や内容についての言及（「勝投手は不明」「勝投手の情報はなし」などと書くこと、または他から推測して補完すること）は一切不要です。提供された情報に存在する内容のみを使用してレポートを構成してください。
- プロのニュースキャスターが冷静に淡々と説明するような、正確で分かりやすい文章にしてください。
- **「！」や「？」などの記号は一切使用せず、句読点のみで構成してください。**
- 見出しやタイトルは含めず、本文のみを作成してください。
- 各プレーについて、情報がある場合は誰が行ったプレーか（打者や投手など）が明確に伝わるように記述してください（情報がない場合は不明なままで構いません）。
...
サンプル：
阪神は2点を追う5回、大山がレフト前へ同点の2点適時打を放った。続く6回には近本がライト線への適時三塁打を放ち、勝ち越しに成功した。さらに7回には佐藤輝がバックスクリーンへの本塁打を放ち、リードを広げた。投げては先発の才木が7回を2失点に抑える好投で今季5勝目を挙げた。終盤は岩崎、ゲラと繋ぐ継投で巨人の反撃を許さず、勝利を収めた。
